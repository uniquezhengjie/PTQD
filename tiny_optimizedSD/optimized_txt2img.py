...
DEFAULT_CKPT = "/home/reexen/projects/stable-diffusion/models/ldm/stable-diffusion-v1/model.ckpt"

parser = argparse.ArgumentParser()

parser.add_argument(
    "--prompt", type=str, nargs="?", default="a dog under the tree", help="the prompt to render"
)
...
for c, t in code2text.items():
    dataset.append("This is a photo of a {}".format(t))
...
with torch.no_grad():
    ...
    for prompt in tqdm(dataset):
        ...
        with precision_scope("cuda"):
            ...
            c = modelCS.get_learned_conditioning(n_samples_per_class * [prompt])
