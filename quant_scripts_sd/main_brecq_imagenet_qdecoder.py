...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        with model.ema_scope():
            ...
            for class_label in classes:
                ...
                # x_samples_ddim = quantized_modelFS(samples_ddim.cpu())
    ...
    image_to_save.save("imagenet_brecq_w{}a{}_step{}_eta{}_scale{}_corrected_qdecoder_n.jpg".format(n_bits_w,n_bits_a,ddim_steps, ddim_eta, scale))
