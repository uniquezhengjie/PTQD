...
if __name__ == '__main__':
    ...
    kwargs = dict(cali_images=cali_images, cali_t=cali_t, cali_y=cali_y, iters=1250, act_quant=True, opt_mode='mse', lr=4e-4, p=2.4, batch_size=batch_size)
    recon_model(qnn)
